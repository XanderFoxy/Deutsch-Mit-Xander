...
const SPRECHBILDER = ["bluete", "regenbogen", "welle"];
...
(async () => {
  ...
  const st = await pg.evaluate(async () => {
    ...
    const pl = document.querySelectorAll(".lc-platz")[1];
    pl.classList.add("lc-platz-spricht");
    /* FUNK 75: der alte Strom heisst jetzt „Strom 2" (strom2); „strom"
       ist die Plasmalampe und wird in pruefe-sprechbilder gemessen. */
    pl.setAttribute("data-sprechbild", "strom2");
    window.DMA_PRUEFUNG.sprechFeld(pl, "strom2");
