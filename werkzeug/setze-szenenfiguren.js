  ...
  { szene: "wohnzimmer", teil: "mutter", x: 238, sitzY: 146,
    z: { alter: "erwachsen", geschlecht: "w", haut: "hell", frisur: "dutt",
         ...
         kleidung: { oberteil: { stueck: "bluse", farbe: "gruen" },
                     ...
                     schuhe: { stueck: "halbschuh", farbe: "braun" } } } },
  /* --- Weitere Szenen, in denen jemand sass und trotzdem stand -----
     Die Sitzhoehe ist aus dem Moebelstueck gemessen: Oberkante plus
     55 % seiner Hoehe trifft bei allen gezeichneten Stuehlen die
     Sitzflaeche. */
  { szene: "klassenzimmer", teil: "schuelerin", x: 77, sitzY: 146,
    z: { alter: "kind", geschlecht: "w", haut: "hell", frisur: "zopf",
         haarfarbe: "dunkelbraun", gesicht: "g1", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "tshirt", farbe: "gelb" },
                     unterteil: { stueck: "hose", farbe: "blau" },
                     schuhe: { stueck: "turnschuh", farbe: "weiss" } } } },
  { szene: "kinderzimmer", teil: "maedchen", x: 159, sitzY: 136,
    z: { alter: "kind", geschlecht: "w", haut: "hell", frisur: "lang",
         haarfarbe: "blond", gesicht: "g1", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "tshirt", farbe: "rosa" },
                     unterteil: { stueck: "rock_knie", farbe: "blau" },
                     schuhe: { stueck: "halbschuh", farbe: "weiss" } } } },
  { szene: "cafe", teil: "ca_gast", x: 270, sitzY: 160,
    z: { alter: "erwachsen", geschlecht: "m", haut: "mittel", frisur: "kurz",
         haarfarbe: "schwarz", gesicht: "g3", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "hemd", farbe: "blau" },
                     unterteil: { stueck: "jeans", farbe: "blau" },
                     schuhe: { stueck: "halbschuh", farbe: "braun" } } } },
  { szene: "bibliothek", teil: "bi_leser", x: 198, sitzY: 169,
    z: { alter: "erwachsen", geschlecht: "m", haut: "hell", frisur: "kurz",
         haarfarbe: "braun", gesicht: "g1", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "pullover", farbe: "grau" },
                     unterteil: { stueck: "hose", farbe: "schwarz" },
                     schuhe: { stueck: "halbschuh", farbe: "schwarz" } } } },
  { szene: "restaurant", teil: "gast", x: 28, sitzY: 165,
    z: { alter: "erwachsen", geschlecht: "w", haut: "hell", frisur: "lang",
         haarfarbe: "dunkelbraun", gesicht: "g1", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "bluse", farbe: "weiss" },
                     unterteil: { stueck: "rock_knie", farbe: "schwarz" },
                     schuhe: { stueck: "halbschuh", farbe: "schwarz" } } } },
  { szene: "bewerbungsgespraech", teil: "bw_bewerber", x: 269, sitzY: 178,
    z: { alter: "erwachsen", geschlecht: "m", haut: "hell", frisur: "kurz",
         haarfarbe: "dunkelbraun", gesicht: "g1", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "hemd", farbe: "weiss" },
                     unterteil: { stueck: "anzughose", farbe: "schwarz" },
                     schuhe: { stueck: "halbschuh", farbe: "schwarz" } } } },
  { szene: "bewerbungsgespraech", teil: "bw_personalerin", x: 59, sitzY: 178,
    z: { alter: "erwachsen", geschlecht: "w", haut: "hell", frisur: "dutt",
         haarfarbe: "schwarz", gesicht: "g3", haltung: "sitzen",
         kleidung: { oberteil: { stueck: "bluse", farbe: "blau" },
                     unterteil: { stueck: "anzughose", farbe: "grau" },
                     schuhe: { stueck: "halbschuh", farbe: "schwarz" } } } },
