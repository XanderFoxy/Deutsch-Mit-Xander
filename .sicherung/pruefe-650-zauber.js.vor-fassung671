...
(async () => {
  ...
  /* Ab Fassung 654 sind es neun Zauber (Brezelflut … Behördengang). */
  sage(zr.da && zr.n === 9, "der Stab öffnet das Zauberrad mit allen neun Zaubern", zr.zahlen);
  ...
  sage(zr.zu === "kaffeeklatsch,muecken,erdbeben,hexenschuss,orkan,gartenzwerg,behoerdengang" && /nebel:25/.test(zr.zahlen) && /brezelflut:20/.test(zr.zahlen) && /erdbeben:Lv5/.test(zr.zahlen) && /orkan:Lv7/.test(zr.zahlen),
       "Level 3: Brezelflut und Nebel offen, die anderen zeigen ihr Level", zr.zu);
