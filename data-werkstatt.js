...
window.DMA_WERKSTATT = {
  ...
  stand: "Runde 88 — der Cowboyhut faellt schief, die Hand richtet ihn am Ende wirklich aus, und der YIHAAH-Ruf ist nicht mehr abgeschnitten.",

  inArbeit: [
    { seit: "2026-09-22T14:50",
  ...
  fertig: [
    { seit: "2026-09-22T14:50",
      text: "Cowboyhut: der Ruf ist nicht mehr abgeschnitten (2,49 s statt 1,86 s, klingt aus statt abzureissen)" },
    { seit: "2026-09-22T14:50",
      text: "Cowboyhut: die Animation dauert 4,4 s statt 3 s" },
    { seit: "2026-09-22T14:50",
      text: "Cowboyhut: der Hut faellt schief auf den Kopf und bleibt waehrend des Rufs schief" },
    { seit: "2026-09-22T14:50",
      text: "Cowboyhut: die Hand ist 1,4 s im Bild statt 510 ms — man sieht sie" },
    { seit: "2026-09-22T14:50",
      text: "Cowboyhut: sie fasst die Krempe an der Kante und dreht den Hut gerade" },
  ],
};
