...
window.DMA_WERKSTATT = {
  ...
  stand: "Runde 88c — jedes Panel hat jetzt sein „Schliessen\" im Rahmen, und das Text-Panel bleibt auf dem Bildschirm.",

  inArbeit: [
    { seit: "2026-09-22T15:12",
  ...
  fertig: [
    { seit: "2026-09-22T15:12",
      text: "Jedes schwebende Panel hat unten im Rahmen einen Schliessen-Knopf" },
    { seit: "2026-09-22T15:12",
      text: "Das Text-Panel (Befehle & Schrift) ist nicht mehr hoeher als der Bildschirm — es rollt in sich" },
    { seit: "2026-09-22T15:12",
      text: "Die Zeile „Was man tippen kann\" bleibt dabei oben stehen" },
    { seit: "2026-09-22T15:12",
      text: "Auch das Text-Panel schliesst beim Tipp in den Leerraum" },
  ],
};
