...
window.DMA_WERKSTATT = {
  ...
  stand: "Fassung 679: Eigene Sitzordnung im Spiel, Menü wie zuerst, Ablegen",

  inArbeit: [
    { seit: "2026-09-25T19:34",
      text: "Scheibenwischer im Chat aufrüstbar (Haltbarkeit), Waffen haltbarer fertigen und mit Zusatzfunktionen" },
    { seit: "2026-09-25T19:34",
  ...
  fertig: [
    { seit: "2026-09-25T19:34",
      text: "Platzwechsel im Spiel sieht nur, wer mitspielt – im Chat bleibst du auf deinem Chatplatz" },
    { seit: "2026-09-25T19:34",
      text: "Spielfenster wieder wie zuerst: Werte untereinander, Niveau über der Aufgabe, Mission in Reichweite" },
    { seit: "2026-09-25T19:34",
      text: "▾ Ablegen: Griff in der Schnellleiste holt das Fenster im selben Reiter zurück" },
    { seit: "2026-09-25T19:34",
      text: "Schmerzstimmen, Erinnerungen, Zauberrad-Ton (Fassung 678)" },
  ],
};
